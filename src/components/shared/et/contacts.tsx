...
export default function EtContacts() {
    return (
            ...
            <Container2 className="flex flex-wrap justify-between gap-3">
                <div className="max-w-155 w-full flex flex-col gap-5 md:gap-11.75">
                    <h2 className="text-4xl md:text-5xl font-medium">
                        Ei leidnud täiuslikku kimpu?
                    </h2>

                    <p className="text-xl md:text-[32px]">
                        Jätke oma andmed ja võtame teiega peagi ühendust.
                    </p>
                    ...
                    <form className="flex flex-col gap-6 " action="">
                        <input
                            ...
                            type="text"
                            placeholder="Nimi"
                            className="border-b-2 border-[#FAF3E1] p-2.5 text-xl md:text-[30px] font-medium placeholder:select-none"
                        />
                        ...
                        <button className="text-center px-11 py-3.75 bg-[#FAF3E1] text-[#222] font-medium text-xl md:text-2xl rounded-[14px] hover:bg-[#E76D24] cursor-pointer duration-300">
                            Tee tellimus
                        </button>
                    </form>
                </div>
